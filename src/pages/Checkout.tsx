  ...
  if (currentStep === 4) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        ...
        <h1 className="text-4xl font-serif font-bold text-brand-olive mb-4">
          Mubarak! Order Placed
        </h1>
        <p className="text-gray-500 mb-12 max-w-md mx-auto">
          Your handcrafted treasures are being prepared. You will receive an
          update via SMS shortly.
        </p>
        ...
        <div className="max-w-xl mx-auto flex items-center justify-between relative mt-12">
          {steps.map((step, idx) => (
            <div key={idx} className="flex flex-col items-center relative z-10">
              <div
                className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold transition-all ${currentStep >= idx ? "bg-brand-olive text-brand-cream shadow-lg" : "bg-gray-100 text-gray-400"}`}
              >
                {idx + 1}
              </div>
              <span
                className={`text-[10px] uppercase tracking-widest mt-3 font-bold ${currentStep >= idx ? "text-brand-olive" : "text-gray-300"}`}
              >
                {step}
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            {currentStep === 0 && (
              ...
              >
                ...
                <p className="text-xs text-red-500 font-medium mb-8">
                  Fields marked with <span className="font-bold">(*)</span> are
                  mandatory.
                </p>
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-6 bg-white border-2 border-brand-olive rounded-3xl">
                    ...
                    <span className="font-bold text-brand-gold uppercase tracking-widest text-xs">
                      Free
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div
                        className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${paymentMethod === "razorpay" ? "border-brand-gold" : "border-gray-300"}`}
                      >
                        {paymentMethod === "razorpay" && (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div
                        className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${paymentMethod === "cod" ? "border-brand-gold" : "border-gray-300"}`}
                      >
                        {paymentMethod === "cod" && (
                          <div className="w-3 h-3 bg-brand-gold rounded-full" />
                        )}
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Pay at the time of delivery (+ ₹30)
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      {items.map((item) => (
                        ...
                        >
                          <Link
                            to={`/product/${item.id}`}
                            className="text-gray-600 hover:text-brand-olive hover:underline transition-colors block"
                          >
        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-8 rounded-[3rem] border border-brand-olive/5 shadow-sm sticky top-24">
            <h2 className="font-serif text-xl font-bold text-brand-olive mb-6">
              Summary
            </h2>
            <div className="space-y-4 text-sm mb-6 pb-6 border-b border-gray-50">
              {items.map((item) => (
                ...
                >
                  <Link
                    to={`/product/${item.id}`}
                    className="line-clamp-1 flex-1 mr-4 hover:text-brand-olive hover:underline transition-colors block"
                  >
                    {item.name}
                  </Link>
