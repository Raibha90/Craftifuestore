...
export default function AdminProducts() {
  ...
  const [imageReqs, setImageReqs] = useState({
    width: "800",
    height: "800",
    format: "PNG",
  });
  ...
  const removeTag = (tagToRemove: string) => {
    setNewProduct({
      ...newProduct,
      tags: newProduct.tags.filter((t) => t !== tagToRemove),
    });
  };
  ...
  return (
    <div className="space-y-12">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
        <div>
          <h1 className="text-4xl font-serif font-bold text-brand-olive uppercase tracking-tight">
            Artisan Catalog
          </h1>
          <p className="text-gray-400 mt-2">
            Curate and manage your fine collection of handcrafted treasures.
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-3xl border border-brand-olive/5 shadow-sm overflow-hidden">
        {loading ? (
          <div className="p-24 text-center text-gray-400 text-sm">
            Organizing catalog...
          </div>
            ...
            <tbody className="divide-y divide-gray-50">
              {filteredProducts.map((product) => (
                ...
                >
                  ...
                  <td className="px-8 py-6 text-sm text-gray-500 uppercase tracking-widest">
                    {product.category}
                  </td>
                  <td className="px-8 py-6">
                    ...
                    <p className="text-[10px] text-gray-500 uppercase tracking-widest">
                      + 18% GST (₹
                      {Math.round(product.price * 0.18).toLocaleString()})
                    </p>
                  ...
                  <td className="px-8 py-6">
                    <span
                      className={`px-2 py-1 rounded-lg text-xs font-bold leading-none ${product.stock < 5 ? "bg-red-50 text-red-500" : "bg-green-50 text-green-600"}`}
                    >
                      {product.stock} units
                    </span>
                  </td>
          ...
          <div className="p-24 text-center space-y-6">
            ...
            <p className="text-gray-400 italic">
              No products in catalog yet. Click "Add New Product" to start.
            </p>
          </div>
        )}
      </div>
            ...
            >
              <div className="p-8 border-b border-gray-50 flex justify-between items-center bg-gray-50/50">
                <div>
                  ...
                  <p className="text-xs text-red-500 font-medium mt-2">
                    Fields marked with <span className="font-bold">(*)</span>{" "}
                    are mandatory.
                  </p>
                </div>
                <button
              ...
              >
                <div className="flex items-center justify-between bg-brand-gold/10 p-4 rounded-2xl">
                  <div>
                    <h4 className="font-serif font-bold text-brand-olive text-sm">
                      AI Product Assistant
                    </h4>
                    <p className="text-xs text-gray-500 mt-1">
                      Generate SEO metadata automatically from name and
                      category.
                    </p>
                  </div>
                  <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2 col-span-2">
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden border border-transparent focus-within:border-brand-gold">
                      <ReactQuill
                  ...
                  <div className="space-y-2 col-span-2">
                    ...
                    <input
                      type="text"
                      className="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-brand-gold outline-none transition-all mb-2"
                    ...
                    <div className="flex flex-wrap gap-2">
                      {newProduct.tags.map((tag) => (
                        <div
                          key={tag}
                          className="flex items-center px-3 py-1 bg-brand-olive/10 text-brand-olive rounded-full text-xs font-bold"
                        >
                          <span>{tag}</span>
                          <button
                            type="button"
                            onClick={() => removeTag(tag)}
                            className="ml-2 text-brand-olive hover:text-red-500"
                          >
                            <X className="w-3 h-3" />
                          </button>
                        </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-[10px] text-gray-400 ml-1 mt-0.5">
                          Uploaded images auto-resize to max 800x800px (JPEG
                          format)
                        </p>
                      </div>
                      <button
                          ...
                          <div className="absolute right-4 flex items-center space-x-2">
                            ...
                            <button
                              ...
                              onClick={() => {
                                ...
                                setAiPrompt(
                                  newProduct.name
                                    ? `A professional studio product photograph of ${newProduct.name}, highly detailed, elegant lighting, plain background, photorealistic.`
                                    : "",
                                );
                              }}
                        ...
                        {img && (
                          <div className="flex items-center space-x-4 ml-2">
                            <img
                              src={img}
                              alt="Preview"
                              className="w-16 h-16 rounded-xl object-cover border border-brand-olive/10"
                  ...
                  <div className="col-span-2 pt-8 border-t border-gray-100">
                    <div className="flex justify-between items-center mb-6">
                      <h4 className="font-serif text-xl font-bold text-brand-olive">
                        Product Variants
                      </h4>
                      <button
                        type="button"
                    ...
                    <div className="space-y-4">
                      {newProduct.variants.map((v, idx) => (
                        <div
                          key={v.id}
                          className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-gray-50/50 p-6 rounded-3xl relative animate-in fade-in slide-in-from-top-2"
                        >
                          <button
                            type="button"
                          ...
                          <div className="space-y-2">
                            ...
                            <select
                              ...
                              value={v.type}
                              onChange={(e) =>
                                updateVariant(v.id, "type", e.target.value)
                              }
                            >
                      ...
                      {newProduct.variants.length === 0 && (
                        <div className="text-center py-12 border-2 border-dashed border-gray-100 rounded-[2.5rem]">
                          <p className="text-sm text-gray-400 italic">
                            No variants defined for this treasure.
                          </p>
                        </div>
                      )}
                    </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-brand-olive text-brand-cream py-5 rounded-full font-bold uppercase tracking-widest text-xs shadow-lg hover:shadow-brand-olive/20 transition-all mt-4"
                >
            ...
            >
              <div className="text-center space-y-2">
                ...
                <p className="text-gray-400 text-sm">
                  Describe the masterpiece you want to visualize. Be specific
                  about materials, lighting, and background.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setImageReqs({ ...imageReqs, width: e.target.value })
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setImageReqs({ ...imageReqs, height: e.target.value })
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setImageReqs({ ...imageReqs, format: e.target.value })
                    }
                  >
