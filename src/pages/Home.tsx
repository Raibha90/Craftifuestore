    ...
    <div className="space-y-24 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          <Link to="/category" className="inline-flex items-center space-x-3 text-[11px] font-bold uppercase tracking-[0.2em] text-brand-olive hover:text-brand-gold transition-colors border-b-2 border-brand-gold/20 pb-2">
